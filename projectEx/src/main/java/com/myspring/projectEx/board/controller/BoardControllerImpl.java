package com.myspring.projectEx.board.controller;
...
import com.myspring.projectEx.board.service.BoardService;
import com.myspring.projectEx.board.vo.ArticleVO;
import com.myspring.projectEx.board.vo.ImageVO;
...
public class BoardControllerImpl  implements BoardController{
	...
	public ModelAndView listArticles(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String viewName = (String)request.getAttribute("viewName"); //�씤�꽣�뀎�꽣�뿉�꽌 �쟾�떖�맂 酉곗씠由�
		List articlesList = boardService.listArticles(); //紐⑤뱺 湲� �젙蹂� 議고쉶
		ModelAndView mav = new ModelAndView(viewName);
		mav.addObject("articlesList", articlesList); //議고쉶�븳 湲� �젙蹂대�� 諛붿씤�뵫 �븳 �썑 JSP濡� �쟾�떖
		return mav;
